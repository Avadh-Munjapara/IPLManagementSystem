        ...
        <div className="flex flex-col gap-5 mt-6">
          {
            user && (
              <>
                <Link to='/dashboard/profile' state={userData} className="text-white px-5 py-3 text-lg flex items-center hover:bg-blue-500 transition">
                  <CgProfile size={22} className="mr-2" /> Profile
                </Link>
                <Link to='/dashboard/teams' className="text-white px-5 py-3 text-lg flex items-center hover:bg-blue-500 transition">
